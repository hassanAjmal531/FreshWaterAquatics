...
@section('main')
    <div id="about">
        ...
        <div class="row" id="frow-1">
            <div class="col col-sm-12 col-md-6" id="image2" style="padding-top: 1%;padding-bottom: 5%;padding-left: 5%;"><img id="image-2" src="{{asset("images/img/freshwaterAqautaics.jpg")}}" width="80%" height="100%" style="width: 100%;height: 100%;"></div>
            <div class="col col-sm-12 col-md-6">
